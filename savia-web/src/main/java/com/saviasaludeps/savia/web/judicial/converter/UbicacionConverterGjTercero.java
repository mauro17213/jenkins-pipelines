 ...
 * @author bsGomez
 */
@FacesConverter("ubicacionConverterGjTercero")
public class UbicacionConverterGjTercero implements Converter{
    @Override
    public Ubicacion getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                GjTerceroBean service = (GjTerceroBean) viewMap.get("gjTerceroBean");
                if(service.getUbicaciones() != null){
