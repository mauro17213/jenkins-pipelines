...
public class RecobroConciliacionBean extends Url {
    ...
    private RcoConciliacion reporteConciliacion;
    ...
    public RcoConciliacion getReporteConciliacion() {
        return reporteConciliacion;
    }

    public void setReporteConciliacion(RcoConciliacion reporteConciliacion) {
    ...
    public void guardarConciliacionGestion() {
        ...
        getRcoConciliacionServicio().Accion(this);
        if (!super.isError()) {
            PrimeFaces.current().ajax().update("frmGestionar:pInformacionGestionar");
    ...
    public StreamedContent generarReporte(int conciliacionId) {
        //getObjeto().setId(conciliacionId);
        ...
        try {
            if (!super.isError()) {
                //List<ReporteHospitalizacion> reporteConciliacion = getAucHospitalizacionServicio().descargarHospitalizacion(this);
                ...
                JRBeanCollectionDataSource beanColDataSource = new JRBeanCollectionDataSource((Collection<?>) reporteConciliacion);
                ...
                stream.mark(0);
                RcoConciliacion conciliacion = getRcoConciliacionServicio().consultarConciliacion(conciliacionId, this);
                ...
                nombreArchivo.append("_rco_coniliacion_");
