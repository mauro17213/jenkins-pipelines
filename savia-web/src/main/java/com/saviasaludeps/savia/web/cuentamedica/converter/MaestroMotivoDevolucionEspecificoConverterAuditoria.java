 ...
 * @author jperezn
 */
@FacesConverter("maestroMotivoDevolucionEspecificoConverterAuditoria")
public class MaestroMotivoDevolucionEspecificoConverterAuditoria implements Converter {
