...
public class AuConstantes {
    ...
    public static final int ESTADO_SOLICITUD_DEVUELTO = 5;
    ...
    public static final String TEXTO_ESTADO_SOLICITUD_DEVUELTO = "EN DEVOLUCION";
    ...
    public static final String TEXTO_CELULAR_AFILIADO = "Celualr Afiliado";
    ...
    public static final String TEXTO_AGRUPADOR_MEDICAMENTO = "Agrupador Medicamento";
    ...
    public static final String ERROR_ADICION_AGRUPADOR_MEDICAMENTO = "El agrupador %s ya fue agregado";
    ...
    public static final String ANULADO_AUTORIZACION = "70";
    ...
    //Tecnonologia especificas con dias de vigencia 30
    public static final List<String> CODIGO_TCNOLOGIAS_ESPECIFICAS_30_VIGENCIAS = Arrays.asList("56370", "56369", "61438", "63826");
    ...
    public final static String CODIGO_AMBITO_MIXTO = "M";    
...
//            listaMaestro.add(mae);
        ...
        while (i <= 5) {
            ...
            switch (i) {
                ...
                case CUATRO:
                    ...
                    break;
                case CINCO:
                    mae.setNombre(TEXTO_AGRUPADOR_MEDICAMENTO);
                    mae.setDescripcion(TEXTO_AGRUPADOR_MEDICAMENTO);
                    mae.setValor("" + i);
                    break;
            }
            listaMaestro.add(mae);
    ...
    public static HashMap<String, Maestro> obtenerHashMaestroValor(List<Maestro> listaMaestros) {
        HashMap<String, Maestro> hash = new HashMap();
        listaMaestros.forEach(maestro -> {
            hash.put(maestro.getValor(), maestro);
        });
        return hash;
    }
        ...
        while (contador <= 3) {
            ...
            switch (contador) {
                ...
                case DOS:
                    ...
                    break;
                case TRES:
                    maestro.setNombre(CARGUE_WEB_SERVICE);
                    maestro.setDescripcion(CARGUE_WEB_SERVICE);
                    lista.add(maestro);
                    break;
            }
            contador++;
    ...
    public static String obtenerTipoTecnologia(int id) {
        switch (id) {
            ...
            case CINCO:
                return TEXTO_AGRUPADOR_MEDICAMENTO;
        }
        return TEXTO_VACIO;
    }
        ...
        while (contador <= 5) {
            ...
            switch (contador) {
                ...
                case CUATRO:
                    ...
                    break;
                case CINCO:
                    mae.setNombre(TEXTO_ESTADO_SOLICITUD_DEVUELTO);
                    mae.setDescripcion(TEXTO_ESTADO_SOLICITUD_DEVUELTO);
                    mae.setValor(COMILLA_DOBLE + contador);
                    lista.add(mae);
                    break;
    ...
    public static List<Maestro> obtenerEstadosItemSolicitud() {
        List<Maestro> lista = new ArrayList();
        AuAnexo3Item item = new AuAnexo3Item();
        for (int i = 0; i < 19; i++) {
            Maestro mae = new Maestro(i);
            item.setEstado(i);
            mae.setNombre(item.getEstadoStr());
            lista.add(mae);
        }
    ...
    public static String nombreReporteAnexo4(AuAnexo4 anexo) {
        int idAnexo4 = anexo.getId();
        //  String fecha = formato6.format(anexo.getFechaHoraCrea());
        String fecha = formato6.format(new Date());
        int origen;
        if (anexo.getAuAnexo2Id() != null) {
            origen = 2;
        } else {
            origen = 3;
        }
        String nombre;
        if (anexo.getEstado() == AuAnexo4.ESTADO_PREAUTORIZADO
                || anexo.getEstado() == AuAnexo4.ESTADO_ANULADA_PREAUTORIZACION) {
            nombre = "Preautorizacion-";
        } else {
            if (anexo.isVersion() == AuConstantes.VERSION_1) {
                nombre = "anexo1-04-";
            } else {
                nombre = "anexo4-";
            }
        }
        return nombre + origen + "_" + idAnexo4 + "_" + fecha + ".pdf";
    }
    ...
    public static String nombreArchivoReporteAnexo4(AuAnexo4 anexo) {
        ...
        //return nombre + anexo.getId() + "_" + anexo.getAfiliadoNumeroDocumento() + "_" + formato2.format(anexo.getFechaHoraCrea()) + ".pdf";
        return nombre + anexo.getId() + "_" + anexo.getAfiliadoNumeroDocumento() + "_" + formato6.format(new Date()) + ".pdf";
    }
    ...
    public static String anexo3ItemEstadoValidacion() {
        StringBuilder estados = new StringBuilder();
        estados.append(AuAnexo3Item.ESTADO_PENDIENTE_AUDITORIA).append(",");
        estados.append(AuAnexo3Item.ESTADO_APROBADO_AUDITORIA).append(",");
        estados.append(AuAnexo3Item.ESTADO_APROBADO_AUTOMATICO).append(",");
        estados.append(AuAnexo3Item.ESTADO_DEVUELTO_AUDITORIA).append(",");
        estados.append(AuAnexo3Item.ESTADO_SIN_COTIZACION).append(",");
        estados.append(AuAnexo3Item.ESTADO_CON_COTIZACION).append(",");
        estados.append(AuAnexo3Item.ESTADO_RECHAZO_COTIZACION).append(",");
        estados.append(AuAnexo3Item.ESTADO_DIRECCIONADO).append(",");
        estados.append(AuAnexo3Item.ESTADO_DIRECCIONADO_AUTOMATICO).append(",");
        estados.append(AuAnexo3Item.ESTADO_PREAUTORIZADO).append(",");
        estados.append(AuAnexo3Item.ESTADO_PENDIENTE_SEGUIMIENTO).append(",");
        estados.append(AuAnexo3Item.ESTADO_AUTORIZADA_PREAUTORIZACION);
        return estados.toString();
    }
    
     public static List<AuTipoRescate> getListadoTipoRescates(){
        return Arrays.asList(AuTipoRescate.values());
    }
