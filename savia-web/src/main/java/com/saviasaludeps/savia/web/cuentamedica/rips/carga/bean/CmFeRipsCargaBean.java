...
//            }
    ...
    public boolean validarReglaAuxiliarRadicacion(CmFeRipsCarga carga) {
        if (this.isAccionAdicional6()) {
            return carga.getRadicadorAsignado().getId() == null;
        }
        return true;
    }
    ...
    public String asignarIndicadorSinEnvioRadicacion(CmFeRipsCarga carga, int indicador) {
        ...
        switch (indicador) {
            ...
            case INDICADOR_PENDIENTE_SOPORTES: 
                ...
                if (carga.getDe4401ProfesionalRed() != null
                        || carga.getDe4402ProfesionalIndependiente() != null
                        || carga.getDe5601Soportes() != null) {
                    estilo = "color: #ff9e00; cursor: pointer;";
