 ...
 * @author ripalacios
 */
@FacesConverter("cntPrestadorSedesAfiliadoConverter")
public class CntPrestadorSedesAfiliadoConverter implements Converter {
    ...
    public CntPrestadorSede getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                for(CntPrestadorSede _obj : service.getListaPrestadoresSedes()){
