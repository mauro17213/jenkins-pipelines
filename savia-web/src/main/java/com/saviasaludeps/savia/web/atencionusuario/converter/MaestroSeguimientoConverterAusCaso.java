 ...
 * @author pavacca
 */
@FacesConverter("maestroSeguimientoConverterAusCaso")
public class MaestroSeguimientoConverterAusCaso implements Converter{
    @Override
    public Maestro getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                for(Maestro _obj : service.getListaTipoSeguimiento()){
