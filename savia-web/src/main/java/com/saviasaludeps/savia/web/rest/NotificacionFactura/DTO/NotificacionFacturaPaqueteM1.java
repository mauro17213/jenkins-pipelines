 ...
 * @author jeperez
 */
public class NotificacionFacturaPaqueteM1 {
    ...
    private List<CmNotificacionFacturaDTO> facturas;
    ...
    public List<CmNotificacionFacturaDTO> getFacturas() {
        return facturas;
    }

    public void setFacturas(List<CmNotificacionFacturaDTO> facturas) {
