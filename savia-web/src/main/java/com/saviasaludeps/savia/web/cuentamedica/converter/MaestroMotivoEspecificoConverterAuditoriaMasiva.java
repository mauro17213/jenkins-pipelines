 ...
 * @author jperezn
 */
@FacesConverter("maestroMotivoEspecificoConverterAuditoriaMasiva")
public class MaestroMotivoEspecificoConverterAuditoriaMasiva implements Converter {
    ...
    public Maestro getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                for(Maestro _obj : service.getListaMaeMotivosEspecificos()){
