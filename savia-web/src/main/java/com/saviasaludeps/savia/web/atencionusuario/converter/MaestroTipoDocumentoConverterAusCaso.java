 ...
 * @author pavacca
 */
@FacesConverter("maestroTipoDocumentoConverterAusCaso")
public class MaestroTipoDocumentoConverterAusCaso implements Converter{
    @Override
    public Maestro getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                for(Maestro _obj : service.getListaTiposDocumento()){
