 ...
 * @author ripalacios
 */
@FacesConverter("ubicacionConverterEmpresa")
public class UbicacionConverterEmpresa implements Converter {
    ...
    public Ubicacion getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                EmpresaBean service = (EmpresaBean) viewMap.get("empresaBean");
