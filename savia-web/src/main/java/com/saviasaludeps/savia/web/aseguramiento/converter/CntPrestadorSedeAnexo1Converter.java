 ...
 * @author ripalacios
 */
@FacesConverter("cntPrestadorSedeAnexo1Converter")
public class CntPrestadorSedeAnexo1Converter implements Converter {
    ...
    public CntPrestadorSede getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                Anexo1Bean service = (Anexo1Bean) viewMap.get("anexo1Bean");
