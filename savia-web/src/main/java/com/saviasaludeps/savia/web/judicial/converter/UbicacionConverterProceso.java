 ...
 * @author bsGomez
 */
@FacesConverter("ubicacionConverterGjProceso")
public class UbicacionConverterProceso implements Converter{
    @Override
    public Ubicacion getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                GjProcesoBean service = (GjProcesoBean) viewMap.get("gjProcesoBean");
