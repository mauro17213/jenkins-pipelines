 ...
 * @author pavacca
 */
@FacesConverter("ubicacionConverterTuTutela")
public class UbicacionConverterTuTutela implements Converter{
    @Override
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                if(viewMap != null){
                    ...
                    if(service != null){
                        if(service.getUbicaciones() != null && !service.getUbicaciones().isEmpty()){
