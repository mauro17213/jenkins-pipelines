 ...
 * @author BsGomez
 */
@FacesValidator("validarSoloStringGj")
public class ValidarSoloStringGj implements Validator {

    private static final String STRING_PATTERN = "^[a-zA-Z /ñÑ.*]+$";

    private Pattern pattern;
    private Matcher matcher;

    public ValidarSoloStringGj() {
