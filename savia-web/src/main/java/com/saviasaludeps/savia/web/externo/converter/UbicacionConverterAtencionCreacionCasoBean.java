 ...
 * @author pavacca
 */
@FacesConverter("ubicacionConverterAtencionCreacionCasoBean")
public class UbicacionConverterAtencionCreacionCasoBean implements Converter{
    @Override
    public Ubicacion getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                AtencionCreacionCasoBean service = (AtencionCreacionCasoBean) viewMap.get("atencionCreacionCasoBean");
