...
import com.saviasaludeps.savia.web.aseguramiento.converter.*;
 ...
 * @author ripalacios
 */
@FacesConverter("ubicacionConverterAusPersonas")
public class UbicacionConverterAusPersonas implements Converter {
    ...
    public Ubicacion getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                AusPersonaBean service = (AusPersonaBean) viewMap.get("ausPersonaBean");
