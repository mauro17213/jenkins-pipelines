...
public class ConnectionManager2{
    ...
    private static ConnectionManager2 instance=null;
   ...
   /**
     ...
     */
    public static ConnectionManager2 getInstance() throws SQLException, ClassNotFoundException {
        if (instance == null){         
            instance = new ConnectionManager2();
            url = PropApl.getInstance().get(PropApl.BD2_CONEXION_URL);
            usr = PropApl.getInstance().get(PropApl.BD2_CONEXION_USUARIO);
            pass = PropApl.getInstance().get(PropApl.BD2_CONEXION_CONTRASENA);
        }
        return instance;
    }
     ...
     * con dichos valores.
     */
    private ConnectionManager2() throws ClassNotFoundException {
