 ...
 */
@Stateless
@Remote(CmFacturaConciliacionRemoto.class)
@Local(CmFacturaConciliacionLocal.class)
public class CmFacturaConciliacionServicio extends GenericoServicio implements CmFacturaConciliacionLocal, CmFacturaConciliacionRemoto {
