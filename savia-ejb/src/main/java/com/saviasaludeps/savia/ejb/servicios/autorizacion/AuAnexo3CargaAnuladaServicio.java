 ...
 */
@Stateless
@Remote(AuAnexo3CargaAnuladaRemoto.class)
public class AuAnexo3CargaAnuladaServicio extends GenericoServicio implements AuAnexo3CargaAnuladaRemoto {

    @Override
    public int consultarCantidadLista(ParamConsulta paramConsulta) throws Exception {
        int cant = 0;
        try {
            String strTitulo = "SELECT COUNT(u) FROM AuAnexo3CargaAnuladas u ";
    ...
    @Override
    public List<AuAnexo3CargaAnulada> consultarLista(ParamConsulta paramConsulta) throws Exception {
        List<AuAnexo3CargaAnulada> listResult = new ArrayList();
        try {
            String strTitulo = "SELECT u FROM AuAnexo3CargaAnuladas u ";
            StringBuilder strQuery = new StringBuilder("WHERE u.id > 0 ");
            StringBuilder sql = new StringBuilder();
            if (paramConsulta.getEmpresaId() != null) {
                strTitulo = agregarJoin("INNER JOIN GnEmpresas gne ON u.gnEmpresasId = gne.id ", strTitulo);
            ...
            List<AuAnexo3CargaAnuladas> list = getEntityManager().createQuery(sql.toString())
                    .setFirstResult(paramConsulta.getPrimerRegistro())
                    .setMaxResults(paramConsulta.getRegistrosPagina())
                    .getResultList();
            for (AuAnexo3CargaAnuladas per : list) {
    ...
    @Override
    public AuAnexo3CargaAnulada consultar(int id) throws Exception {
        AuAnexo3CargaAnulada objRes = null;
        try {
            objRes = castEntidadNegocioLargo((AuAnexo3CargaAnuladas) getEntityManager().find(AuAnexo3CargaAnuladas.class, id));
        } catch (NoResultException e) {
            objRes = null;
        } catch (Exception e) {
    ...
    @Override
    public int insertar(AuAnexo3CargaAnulada obj) throws Exception {
        int _id = 0;
        try {
    ...
    @Override
    public void actualizar(AuAnexo3CargaAnulada obj) throws Exception {
        try {
            String hql = "UPDATE AuAnexo3CargaAnuladas SET "
                    + "estado = :estado "
                    + ", registros = :registros "
                    + ", exitosos = :exitosos "
                    + ", fallidos = :fallidos "
    ...
    @Override
    public void actualizarProceso(AuAnexo3CargaAnulada obj) throws Exception {
        try {
            String hql = "UPDATE AuAnexo3CargaAnuladas SET "
                    + "estado = :estado "
                    + ", exitosos = :exitosos "
    ...
    @Override
    public void actualizarEstado(AuAnexo3CargaAnulada obj) throws Exception {
        try {
            String hql = "UPDATE AuAnexo3CargaAnuladas SET "
                    + "estado = :estado "
                    + "WHERE id = :id ";
    ...
    @Override
    public List<AuAnexo3CargaAnulada> consultarArchivoNombre(String nombre) throws java.lang.Exception {
        List<AuAnexo3CargaAnulada> listaResultados = new ArrayList();
        try {
            String strQuery = "FROM AuAnexo3CargaAnuladas c WHERE c.nombre = '" + nombre + "' AND c.estado <> 2";
            List<AuAnexo3CargaAnuladas> list = getEntityManager().createQuery(strQuery)
                    .getResultList();
            for (AuAnexo3CargaAnuladas anexo3Carga : list) {
    ...
    @Override
    public List<AuAnexo3CargaAnulada> consultarEstadoProceso(int idEmpresa) throws java.lang.Exception {
        List<AuAnexo3CargaAnulada> listaResultados = new ArrayList();
        try {
            String strQuery = "FROM AuAnexo3CargaAnuladas c WHERE c.estado IN (0, 1) AND c.gnEmpresasId.id = '" + idEmpresa + "'"
                    + " ORDER BY c.id DESC";
            List<AuAnexo3CargaAnuladas> list = getEntityManager().createQuery(strQuery)
                    .getResultList();
            for (AuAnexo3CargaAnuladas anexo3Carga : list) {
    ...
    @Override
    public AuAnexo3CargaAnulada consultarSiguienteCarga(int estado) throws Exception {
        AuAnexo3CargaAnulada result = null;
        try {
            String strQuery = "FROM AuAnexo3CargaAnuladas c WHERE c.estado = " + estado + " ORDER BY c.id DESC";
            List<AuAnexo3CargaAnuladas> list = getEntityManager().createQuery(strQuery)
                    .getResultList();
            for (AuAnexo3CargaAnuladas anexo3Carga : list) {
    ...
    public static AuAnexo3CargaAnulada castEntidadNegocioCorto(AuAnexo3CargaAnuladas ent) {
        AuAnexo3CargaAnulada obj = new AuAnexo3CargaAnulada();
        obj.setId(ent.getId());
    ...
    public static AuAnexo3CargaAnulada castEntidadNegocioLargo(AuAnexo3CargaAnuladas ent) {
        AuAnexo3CargaAnulada obj = new AuAnexo3CargaAnulada();
        obj.setId(ent.getId());
    ...
    public static AuAnexo3CargaAnuladas castNegocioEntidad(AuAnexo3CargaAnulada obj) {
        AuAnexo3CargaAnuladas ent = new AuAnexo3CargaAnuladas();
        ent.setId(obj.getId());
