    ...
    public List<MapaAfiliado> consultarListaMapaAfiliados(ParamConsulta paramConsulta) throws Exception {
        ...
        try {
            ...
            if (paramConsulta.getParametroConsulta3() != null) {
                strQuery += "AND p.maeRegimenId = " + (String) paramConsulta.getParametroConsulta2() + " ";
            }
            //Genero
            if (paramConsulta.getParametroConsulta4() != null) {
                strQuery += "AND p.maeGeneroId = " + (String) paramConsulta.getParametroConsulta3() + " ";
            }
            //Modelo Liquidación
            if (paramConsulta.getParametroConsulta5() != null) {
                strQuery += "AND p.maeModeloLiquidacionId = " + (String) paramConsulta.getParametroConsulta4() + " ";
            }
