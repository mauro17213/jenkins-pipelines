 ...
 * @author  jepn
 */
public class FinCarga extends Auditoria implements Serializable {
    ...
    public static final int ESTADO_FALLIDO = 4;
    ...
    public void setRespExiste(Boolean respExiste) {
     ...
     public String getEstadoStr() {
        return FinCarga.getEstadoStr(getEstado());
    }
