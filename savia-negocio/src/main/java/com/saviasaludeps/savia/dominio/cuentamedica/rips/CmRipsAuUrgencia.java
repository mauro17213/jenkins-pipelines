...
public class CmRipsAuUrgencia extends Auditoria {
    ...
    public String toString() {
        return "CmRipsAuUrgencia{" + "id=" + id + ", numeroFactura=" + numeroFactura + ", codigoReps=" + codigoReps + ", maeTipoDocumentoCodigo=" + maeTipoDocumentoCodigo + ", documentoAfiliado=" + documentoAfiliado + ", archivoNombreOriginal=" + archivoNombreOriginal + ", archivoRuta=" + archivoRuta + ", archivoNombre=" + archivoNombre + ", cmRipsCarga=" + cmRipsCarga.getId() + '}';
    }
