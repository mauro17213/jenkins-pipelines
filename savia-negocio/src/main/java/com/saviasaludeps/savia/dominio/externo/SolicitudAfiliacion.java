 ...
 * @author admin
 */
public class SolicitudAfiliacion extends Auditoria{
    ...
    private boolean esSmsNotificacion;
    private boolean esCorreoNotificacion;
    ...
    public SolicitudAfiliacion(Integer id) {
        this.id = id;
        ciudadResidencia = new Ubicacion();
    }
    ...
    public String getTipoEstadoStr() {
        return SolicitudAfiliacion.getZonaStr(getZona());
    }
    ...
    public boolean isEsSmsNotificacion() {
        return esSmsNotificacion;
    }

    public void setEsSmsNotificacion(boolean esSmsNotificacion) {
        this.esSmsNotificacion = esSmsNotificacion;
    }

    public boolean isEsCorreoNotificacion() {
        return esCorreoNotificacion;
    }

    public void setEsCorreoNotificacion(boolean esCorreoNotificacion) {
        this.esCorreoNotificacion = esCorreoNotificacion;
    }
    ...
    public static Map<String, String> getTipoZonas() {
        ...
        tipos.put(SolicitudAfiliacion.getZonaStr(ZONA_URBANA), SolicitudAfiliacion.ZONA_URBANA);
        tipos.put(SolicitudAfiliacion.getZonaStr(ZONA_RURAL), SolicitudAfiliacion.ZONA_RURAL);
        return tipos;
    }
