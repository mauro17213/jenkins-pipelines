 ...
 * @author jyperez
 */
public class CntContratoCargaSuceso extends Auditoria {
    ...
    private CntContratoCarga cntContratoCarga;

    public CntContratoCargaSuceso() {
    }

    public CntContratoCargaSuceso(Integer id) {
        this.id = id;
    }

    public CntContratoCargaSuceso(Integer id, String detalleFallo, Date fechaHoraProceso) {
        this.id = id;
    ...
    /**
     * @return the cntContratoCarga
     */
    public CntContratoCarga getCntContratoCarga() {
        return cntContratoCarga;
    }

    /**
     * @param cntContratoCarga the cntContratoCarga to set
     */
    public void setCntContratoCarga(CntContratoCarga cntContratoCarga) {
        this.cntContratoCarga = cntContratoCarga;
    }
