 ...
 * @author NEXOS
 */
public class AuAnexo4CargaAnulada extends Auditoria{
    ...
    private List<AuAnexo4CargaAnuladaSuceso> auAnexo4CargaAnuladaSucesosList;
    
    //variable adicionales
    private transient InputStream adjuntoStream;
    
    public AuAnexo4CargaAnulada(){
        
    }
    
    public AuAnexo4CargaAnulada(Integer id){
        this.id = id;
    }
    ...
    public List<AuAnexo4CargaAnuladaSuceso> getAuAnexo4CargaAnuladaSucesosList() {
        return auAnexo4CargaAnuladaSucesosList;
    }

    public void setAuAnexo4CargaAnuladaSucesosList(List<AuAnexo4CargaAnuladaSuceso> auAnexo4CargaAnuladaSucesosList) {
    ...
    public String getGenerarNombreArchivo() {
        ...
        archivo = "carga_anulada_autorizaciones" + "_" + df.format(new Date()) + ext;
        return archivo;
    }
