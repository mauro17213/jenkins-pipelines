...
public class CmFeRipsCargaAdjunto extends Auditoria {
    ...
    public CmFeRipsCargaAdjunto() {
    }

    public CmFeRipsCargaAdjunto( String nombre, String ruta, InputStream inputStream) {
    ...
    public String getTipoStr() {
        return CmFeRipsCargaAdjunto.getTipoStr(getTipo());
    }
    ...
    public String getGenerarNuevoNombreArchivo(String postFijo) {
        ...
        String postFijoIn =  postFijo != null && !postFijo.equals("") ? postFijo :"";
        archivo = "carga_" + getCmFeRipsCarga().getId() + "_" + getTipo()+ "_" + getIdInsertar() + "_" + df.format(getFechaHoraCrea()) +postFijoIn+ ext;
        return archivo;
    }
