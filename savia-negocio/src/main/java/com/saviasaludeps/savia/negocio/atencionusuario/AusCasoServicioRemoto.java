 ...
 * @author sgiraldov
 */
public interface AusCasoServicioRemoto {
    ...
    /**
     * Método para actualizar la información de  Servicio para borrar
     * @param obj (Servicio) Objeto actualizado
     * @throws java.lang.Exception
     */
    void actualizarBorrarCaso(AusCasoServicio obj)throws Exception;
     ...
     * @throws java.lang.Exception
     */
    void actualizarEstadoCerrado(AusCasoServicio obj)throws Exception;
     ...
     * @throws Exception 
     */
    List<AusCasoServicio> consultarServiciosCerradoOresueltos(Integer idCaso) throws Exception;
     ...
     * @throws Exception 
     */
    List<AusCasoServicio> consultarServiciosTodoServicios(Integer idCaso) throws Exception;
     ...
     * @throws Exception 
     */
    List<AusCasoServicio> consultarServiciosDiferenteCerradosoResultos(Integer idCaso) throws Exception;
}
