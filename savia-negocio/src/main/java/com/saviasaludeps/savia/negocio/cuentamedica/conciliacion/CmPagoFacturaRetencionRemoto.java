...
public interface CmPagoFacturaRetencionRemoto {
     ...
     */
    CmPagoFacturaRetencion consultar(int id) throws Exception;
     ...
     * @throws java.lang.Exception
     */
    int insertar(CmPagoFacturaRetencion per) throws Exception;
     ...
     * @throws java.lang.Exception
     */
    void actualizar(CmPagoFacturaRetencion per) throws Exception;
     ...
     * @throws java.lang.Exception
     */
    CmPagoFacturaRetencion eliminar(int id) throws Exception;
