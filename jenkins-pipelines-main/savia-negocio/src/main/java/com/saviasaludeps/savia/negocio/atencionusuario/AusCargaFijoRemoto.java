 ...
 */
@Remote
public interface AusCargaFijoRemoto {
     ...
     * @throws Exception 
     */
    List<AusCargaFijo> consultarLista(ParamConsulta paramConsulta) throws Exception;
     ...
     */
    AusCargaFijo consultar(int id)throws Exception;
