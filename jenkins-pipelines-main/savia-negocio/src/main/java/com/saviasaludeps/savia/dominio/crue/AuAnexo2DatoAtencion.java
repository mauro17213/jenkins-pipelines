 ...
 */
public class AuAnexo2DatoAtencion extends Auditoria {
    ...
    public AuAnexo2DatoAtencion() {
    }

    public AuAnexo2DatoAtencion(Integer id) {
        this.id = id;
    }
    ...
    public String toString() {
        ...
        return "AuAnexo2DatoClinico{" + "id=" + id + ", fechaHoraDatos=" + fechaHoraDatos + ", antecedentes=" + antecedentes + ", resumenClinico=" + resumenClinico + ", temperatura=" + temperatura + 
                ...
                ", sistemaGenitoUrinario=" + sistemaGenitoUrinario + ", sistemaOsteomuscular=" + sistemaOsteomuscular + ", observacionGeneral=" + observacionGeneral + ", auAnexo2=" + auAnexo2 +
