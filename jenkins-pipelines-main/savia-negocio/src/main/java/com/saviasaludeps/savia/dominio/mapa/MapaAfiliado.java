...
import com.saviasaludeps.savia.dominio.aseguramiento.*;
 ...
 * @author jyperez
 */
public class MapaAfiliado extends Auditoria implements Cloneable {
    ...
    public MapaAfiliado(Integer id) {
        this.id = id;
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        return (MapaAfiliado) super.clone();
    }
