...
@FacesConverter("ubicacionConverterTuJuzgado")
public class UbicacionConverterTuJuzgado implements Converter {
    ...
    public Ubicacion getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                TuJuzgadoBean service = (TuJuzgadoBean) viewMap.get("tuJuzgadoBean");
