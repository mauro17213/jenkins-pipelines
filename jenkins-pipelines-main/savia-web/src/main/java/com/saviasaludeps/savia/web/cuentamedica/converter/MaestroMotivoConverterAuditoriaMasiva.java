 ...
 * @author jperezn
 */
@FacesConverter("maestroMotivoConverterAuditoriaMasiva")
public class MaestroMotivoConverterAuditoriaMasiva implements Converter {
    ...
    public Maestro getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                for(Maestro _obj : service.getListaMaeMotivos()){
