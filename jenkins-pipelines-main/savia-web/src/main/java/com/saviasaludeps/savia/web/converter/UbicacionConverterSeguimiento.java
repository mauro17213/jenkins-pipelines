 ...
 */
package com.saviasaludeps.savia.web.converter;
 ...
 * @author iavenega
 */
@FacesConverter("ubicacionConverterSeguimiento")
public class UbicacionConverterSeguimiento implements Converter {
    ...
    public Ubicacion getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                AuSeguimientoBean service = (AuSeguimientoBean) viewMap.get("auSeguimientoBean");
                 for(Ubicacion _obj : service.getListaUbicacion()){
