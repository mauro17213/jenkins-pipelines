 ...
 */
package com.saviasaludeps.savia.web.mapa.converter;
 ...
 * @author ripalacios
 */
@FacesConverter("ubicacionConverterMapaAfiliado")
public class UbicacionConverterMapaAfiliado implements Converter {
    ...
    public Ubicacion getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                MapaAfiliadoBean service = (MapaAfiliadoBean) viewMap.get("mapaAfiliadoBean");
                for(Ubicacion _obj : service.getListaFiltroUbicaciones()){
